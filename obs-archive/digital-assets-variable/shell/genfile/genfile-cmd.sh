...
function createGenesisBlock(){
  ...
  export FABRIC_CFG_PATH=/etc/config/org0
  ...
  OUTPUT_FILE_PATH=/etc/genfile/system-genesis-block/genesis.block
...
function createChannelTx(){
  ...
  OUTPUT_FILE_PATH=/etc/genfile/channel-artifacts/${CHANNEL_NAME}.tx
