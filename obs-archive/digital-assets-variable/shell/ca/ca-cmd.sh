...
function enrollCA() {
  ...
  if [ ${ORG} =  'org0' ]; then
    export FABRIC_CA_CLIENT_HOME=/etc/organizations/ordererOrganizations/org0.company.com
  else
    export FABRIC_CA_CLIENT_HOME=/etc/organizations/peerOrganizations/${ORG}.company.com
  fi
...
function regdEnrollOrderer() {
  ...
  export FABRIC_CA_CLIENT_HOME=/etc/organizations/ordererOrganizations/${ORG}.company.com
